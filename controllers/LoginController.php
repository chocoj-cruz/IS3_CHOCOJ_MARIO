...
class LoginController
{
    ...
    public static function logout()
    {
        ...
        $_SESSION = [];
        session_destroy();
        header('Location: /IS3_CHOCOJ_MARIO/');
    }
    ...
    public static function registroAPI()
    {
        ...
        $_POST['usu_serial'] = filter_var($_POST['usu_serial'], FILTER_SANITIZE_NUMBER_INT);
        ...
        try {
            ...
            if ($usuario->validarUsuarioExistente()) {
                echo json_encode([
                    'codigo' => 0,
                    'mensaje' => 'Ya existe un usuario registrado con este serial',
        ...
        try {
            ...
            if ($usuario->validarUsuarioExistente()) {
                ...
                echo json_encode([
                    ...
                    'detalle' => 'No existe un usuario registrado con el serial proporcionado',
                ]);
                exit;
            }
        } catch (Exception $e) {
